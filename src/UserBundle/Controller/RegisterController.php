...
class RegisterController extends Controller
{
    ...
    public function registerAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $template = $this->render('default/accueil/new_user_mail_templateNew.html.twig', array(
            ...
            $error = null;
            return $this->render('default/accueil/confirmRegister.html.twig', array(
                'error' => $error,
            ));
        ...
        END:
        return $this->render('default/accueil/register.html.twig', array(
